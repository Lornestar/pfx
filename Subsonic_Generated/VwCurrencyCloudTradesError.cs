...
namespace Peerfx_DB{
    /// <summary>
    /// Strongly-typed collection for the VwCurrencyCloudTradesError class.
    /// </summary>
    [Serializable]
    public partial class VwCurrencyCloudTradesErrorCollection : ReadOnlyList<VwCurrencyCloudTradesError, VwCurrencyCloudTradesErrorCollection>
    {        
        public VwCurrencyCloudTradesErrorCollection() {}
    }
    /// <summary>
    /// This is  Read-only wrapper class for the vw_CurrencyCloud_Trades_Errors view.
    /// </summary>
    [Serializable]
    public partial class VwCurrencyCloudTradesError : ReadOnlyRecord<VwCurrencyCloudTradesError>, IReadOnlyRecord
    {
        ...
        private static void GetTableSchema() 
        {
            ...
            {
                //Schema declaration
                TableSchema.Table schema = new TableSchema.Table("vw_CurrencyCloud_Trades_Errors", TableType.View, DataService.GetInstance("Peerfx"));
                ...
                DataService.Providers["Peerfx"].AddSchema("vw_CurrencyCloud_Trades_Errors",schema);
            }
        }
        #endregion
	    ...
	    #region .ctors
	    public VwCurrencyCloudTradesError()
	    {
            SetSQLProps();
            SetDefaults();
            MarkNew();
        }
        public VwCurrencyCloudTradesError(bool useDatabaseDefaults)
	    {
		    SetSQLProps();
	    ...
	    public VwCurrencyCloudTradesError(object keyID)
	    {
		    SetSQLProps();
		    LoadByKey(keyID);
	    }
    	 
	    public VwCurrencyCloudTradesError(string columnName, object columnValue)
        {
            SetSQLProps();
        ...
        public string Request 
	    {
		    get
		    {
			    return GetColumnValue<string>("request");
		    }
            set 
		    {
			    SetColumnValue("request", value);
            }
        }
        ...
        public DateTime Dateoccured 
	    {
		    get
		    {
			    return GetColumnValue<DateTime>("dateoccured");
		    }
            set 
		    {
			    SetColumnValue("dateoccured", value);
            }
        }
