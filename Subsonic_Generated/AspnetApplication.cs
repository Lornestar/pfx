...
namespace Peerfx_DB
{
	...
	public partial class AspnetApplication : ActiveRecord<AspnetApplication>, IActiveRecord
	{
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("aspnet_Applications", TableType.Table, DataService.GetInstance("Peerfx"));
				...
				DataService.Providers["Peerfx"].AddSchema("aspnet_Applications",schema);
			}
		}
		#endregion
		...
		public Peerfx_DB.AspnetUserCollection AspnetUsers()
		{
			return new Peerfx_DB.AspnetUserCollection().Where(AspnetUser.Columns.ApplicationId, ApplicationId).Load();
		}
		#endregion
