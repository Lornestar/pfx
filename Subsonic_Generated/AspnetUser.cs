...
namespace Peerfx_DB
{
	...
	public partial class AspnetUser : ActiveRecord<AspnetUser>, IActiveRecord
	{
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("aspnet_Users", TableType.Table, DataService.GetInstance("Peerfx"));
				...
				DataService.Providers["Peerfx"].AddSchema("aspnet_Users",schema);
			}
		}
		#endregion
		...
		/// 
		/// </summary>
		public Peerfx_DB.AspnetApplication AspnetApplication
		{
			get { return Peerfx_DB.AspnetApplication.FetchByID(this.ApplicationId); }
