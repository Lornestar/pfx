...
namespace Peerfx_DB{
    /// <summary>
    /// Strongly-typed collection for the VwCurrencyCloudTrade class.
    /// </summary>
    [Serializable]
    public partial class VwCurrencyCloudTradeCollection : ReadOnlyList<VwCurrencyCloudTrade, VwCurrencyCloudTradeCollection>
    {        
        public VwCurrencyCloudTradeCollection() {}
    }
    /// <summary>
    /// This is  Read-only wrapper class for the vw_CurrencyCloud_Trades view.
    /// </summary>
    [Serializable]
    public partial class VwCurrencyCloudTrade : ReadOnlyRecord<VwCurrencyCloudTrade>, IReadOnlyRecord
    {
        ...
        private static void GetTableSchema() 
        {
            ...
            {
                //Schema declaration
                TableSchema.Table schema = new TableSchema.Table("vw_CurrencyCloud_Trades", TableType.View, DataService.GetInstance("Peerfx"));
                ...
                colvarCurrencycloudTradeKey.AutoIncrement = false;
                colvarCurrencycloudTradeKey.IsNullable = false;
                colvarCurrencycloudTradeKey.IsPrimaryKey = false;
                ...
                TableSchema.TableColumn colvarCctradeStatus = new TableSchema.TableColumn(schema);
                colvarCctradeStatus.ColumnName = "cctrade_status";
                colvarCctradeStatus.DataType = DbType.Int32;
                colvarCctradeStatus.MaxLength = 0;
                colvarCctradeStatus.AutoIncrement = false;
                colvarCctradeStatus.IsNullable = false;
                colvarCctradeStatus.IsPrimaryKey = false;
                colvarCctradeStatus.IsForeignKey = false;
                colvarCctradeStatus.IsReadOnly = false;
                
                schema.Columns.Add(colvarCctradeStatus);
                
                
                BaseSchema = schema;
                //add this schema to the provider
                //so we can query it later
                DataService.Providers["Peerfx"].AddSchema("vw_CurrencyCloud_Trades",schema);
            }
        }
        #endregion
	    ...
	    #region .ctors
	    public VwCurrencyCloudTrade()
	    {
            SetSQLProps();
            SetDefaults();
            MarkNew();
        }
        public VwCurrencyCloudTrade(bool useDatabaseDefaults)
	    {
		    SetSQLProps();
	    ...
	    public VwCurrencyCloudTrade(object keyID)
	    {
		    SetSQLProps();
		    LoadByKey(keyID);
	    }
    	 
	    public VwCurrencyCloudTrade(string columnName, object columnValue)
        {
            SetSQLProps();
        ...
        public long CurrencycloudTradeKey 
	    {
		    get
		    {
			    return GetColumnValue<long>("currencycloud_trade_key");
		    }
            set 
		    {
			    SetColumnValue("currencycloud_trade_key", value);
            }
        }
        ...
        public long? SettlementKey 
	    {
		    get
		    {
			    return GetColumnValue<long?>("settlement_key");
		    }
            set 
		    {
			    SetColumnValue("settlement_key", value);
            }
        }
        ...
        public string CcTradeid 
	    {
		    get
		    {
			    return GetColumnValue<string>("cc_tradeid");
		    }
            set 
		    {
        ...
        public DateTime? SettlementDate 
	    {
		    get
		    {
			    return GetColumnValue<DateTime?>("settlement_date");
		    }
            set 
		    {
			    SetColumnValue("settlement_date", value);
            }
        }
        ...
        [XmlAttribute("CctradeStatus")]
        [Bindable(true)]
        public int CctradeStatus 
	    {
		    get
		    {
			    return GetColumnValue<int>("cctrade_status");
		    }
            set 
		    {
			    SetColumnValue("cctrade_status", value);
            }
        }
	    ...
	    public struct Columns
	    {
            ...
            public static string CctradeStatus = @"cctrade_status";
