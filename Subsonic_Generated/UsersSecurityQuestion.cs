...
{
	/// <summary>
	/// Strongly-typed collection for the UsersSecurityQuestion class.
	/// </summary>
    [Serializable]
	public partial class UsersSecurityQuestionCollection : ActiveList<UsersSecurityQuestion, UsersSecurityQuestionCollection>
	{	   
		public UsersSecurityQuestionCollection() {}
        
        /// <summary>
		/// Filters an existing collection based on the set criteria. This is an in-memory filter
		/// Thanks to developingchris for this!
        /// </summary>
        /// <returns>UsersSecurityQuestionCollection</returns>
		public UsersSecurityQuestionCollection Filter()
        {
            for (int i = this.Count - 1; i > -1; i--)
            {
                UsersSecurityQuestion o = this[i];
	...
	/// <summary>
	/// This is an ActiveRecord class which wraps the Users_Security_Questions table.
	/// </summary>
	[Serializable]
	public partial class UsersSecurityQuestion : ActiveRecord<UsersSecurityQuestion>, IActiveRecord
	{
		#region .ctors and Default Settings
		
		public UsersSecurityQuestion()
		{
		  SetSQLProps();
		  InitSetDefaults();
		  MarkNew();
		...
		public UsersSecurityQuestion(bool useDatabaseDefaults)
		{
			SetSQLProps();
		...
		public UsersSecurityQuestion(object keyID)
		{
			SetSQLProps();
			InitSetDefaults();
			LoadByKey(keyID);
		...
		public UsersSecurityQuestion(string columnName, object columnValue)
		{
			SetSQLProps();
			InitSetDefaults();
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("Users_Security_Questions", TableType.Table, DataService.GetInstance("Peerfx"));
				schema.Columns = new TableSchema.TableColumnCollection();
				schema.SchemaName = @"dbo";
				//columns
				
				TableSchema.TableColumn colvarUsersSecurityQuestionsKey = new TableSchema.TableColumn(schema);
				colvarUsersSecurityQuestionsKey.ColumnName = "users_security_questions_key";
				colvarUsersSecurityQuestionsKey.DataType = DbType.Int32;
				colvarUsersSecurityQuestionsKey.MaxLength = 0;
				colvarUsersSecurityQuestionsKey.AutoIncrement = true;
				colvarUsersSecurityQuestionsKey.IsNullable = false;
				colvarUsersSecurityQuestionsKey.IsPrimaryKey = true;
				colvarUsersSecurityQuestionsKey.IsForeignKey = false;
				colvarUsersSecurityQuestionsKey.IsReadOnly = false;
				colvarUsersSecurityQuestionsKey.DefaultSetting = @"";
				colvarUsersSecurityQuestionsKey.ForeignKeyTableName = "";
				schema.Columns.Add(colvarUsersSecurityQuestionsKey);
				...
				DataService.Providers["Peerfx"].AddSchema("Users_Security_Questions",schema);
			}
		}
		#endregion
		...
		[XmlAttribute("UsersSecurityQuestionsKey")]
		[Bindable(true)]
		public int UsersSecurityQuestionsKey 
		{
			get { return GetColumnValue<int>(Columns.UsersSecurityQuestionsKey); }
			set { SetColumnValue(Columns.UsersSecurityQuestionsKey, value); }
		}
		...
		/// </summary>
		public static void Update(int varUsersSecurityQuestionsKey,int varUserKey,int varQuestion,string varAnswer,DateTime varDateCreated,DateTime varLastChanged)
		{
			UsersSecurityQuestion item = new UsersSecurityQuestion();
			
				item.UsersSecurityQuestionsKey = varUsersSecurityQuestionsKey;
        ...
        public static TableSchema.TableColumn UsersSecurityQuestionsKeyColumn
        {
		...
		{
			 public static string UsersSecurityQuestionsKey = @"users_security_questions_key";
